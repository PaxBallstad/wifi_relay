...
char ssid[] = "SHAW-66C571";        // your network SSID (name)
char pass[] = "277690900";    // your network password (use for WPA, or use as key for WEP)
...
const int RELAY_ENABLE1 = 2;
const int RELAY_ENABLE2 = 3;
const int RELAY_ENABLE3 = 4;
const int RELAY_ENABLE4 = 5; 
const int RELAY_ENABLE5 = 6; 
const int RELAY_ENABLE6 = 7; 
}
void setup()
{
  pinMode(RELAY_ENABLE1, OUTPUT);
  pinMode(RELAY_ENABLE2, OUTPUT);
  pinMode(RELAY_ENABLE3, OUTPUT);
  pinMode(RELAY_ENABLE4, OUTPUT);
  pinMode(RELAY_ENABLE5, OUTPUT);
  pinMode(RELAY_ENABLE6, OUTPUT);
...
void loop()
{
  Serial.println ("Replay ON");
  digitalWrite(RELAY_ENABLE1, LOW); 
  delay(3000);
  Serial.println("Replay OFF");
  digitalWrite(RELAY_ENABLE1, HIGH); 
  delay(3000);
  
  Serial.println ("Replay ON");
  digitalWrite(RELAY_ENABLE2, LOW); 
  delay(3000);
  Serial.println("Replay OFF");
  digitalWrite(RELAY_ENABLE2, HIGH); 
  delay(3000);

  Serial.println ("Replay ON");
  digitalWrite(RELAY_ENABLE3, LOW); 
  delay(3000);
  Serial.println("Replay OFF");
  digitalWrite(RELAY_ENABLE3, HIGH); 
  delay(3000);

  Serial.println ("Replay ON");
  digitalWrite(RELAY_ENABLE4, LOW); 
  delay(3000);
  Serial.println("Replay OFF");
  digitalWrite(RELAY_ENABLE4, HIGH); 
  delay(3000);
  
  Serial.println ("Replay ON");
  digitalWrite(RELAY_ENABLE5, LOW); 
  delay(3000);
  Serial.println("Replay OFF");
  digitalWrite(RELAY_ENABLE5, HIGH); 
  delay(3000);
  
  Serial.println ("Replay ON");
  digitalWrite(RELAY_ENABLE6, LOW); 
  delay(3000);
  Serial.println("Replay OFF");
  digitalWrite(RELAY_ENABLE6, HIGH); 
  delay(3000);
